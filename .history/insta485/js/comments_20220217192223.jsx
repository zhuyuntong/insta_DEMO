...
class Comments extends React.Component {
  ...
  render() {
    ...
    const commentss = comments.map((object) => (
      // commentss.push(
      <Comment
        link={link}
        commentid={object.value.commentid}
        lognameOwnsThis={object.value.lognameOwnsThis}
        owner={object.value.owner}
        ownerShowUrl={object.value.ownerShowUrl}
