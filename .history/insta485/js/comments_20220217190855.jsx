  ...
  render() {
    ...
    Object.keys(comments).map([key,value]) => {
      commentss.push(
        <Comment
          link={link}
          commentid={comments[key].commentid}
          lognameOwnsThis={comments[key].lognameOwnsThis}
          owner={comments[key].owner}
          ownerShowUrl={comments[key].ownerShowUrl}
          text={comments[key].text}
          url={comments[key].url}
