...
def test_login(live_server, driver):
    ...
    assert react_entry.find_element(
        By.XPATH, ".//*"
...
def test_feed_load(live_server, driver):
    ...
    assert "/static/js/bundle.js" in script_element.get_attribute(
        "src"
    )
    ...
    assert driver.find_elements(By.XPATH, "//a[@href='/posts/2/']")
    assert driver.find_elements(By.XPATH, "//a[@href='/posts/3/']")
    assert driver.find_elements(
        By.XPATH, "//a[@href='/users/awdeorio/']"
    )
    assert driver.find_elements(
        By.XPATH, "//a[@href='/users/jflinn/']"
    )
    assert driver.find_elements(
        By.XPATH, "//a[@href='/users/michjc/']"
    )
    ...
    assert driver.find_elements(
        By.XPATH,
        "//*[contains(normalize-space(.), '#chickensofinstagram')]",
    )
    assert driver.find_elements(
        By.XPATH, "//*[contains(normalize-space(.), 'I <3 chickens')]"
    )
    assert driver.find_elements(
        By.XPATH,
        "//*[contains(normalize-space(.), 'Cute overload!')]",
    )
    assert driver.find_elements(
        By.XPATH,
        "//*[contains(normalize-space(.), 'Sick #crossword')]",
    )
    assert driver.find_elements(
        By.XPATH,
...
def test_new_comment(live_server, driver):
    ...
    comment_fields = driver.find_elements(
        By.XPATH,
    ...
    assert driver.find_elements(
        By.XPATH, "//*[text()[contains(.,'test comment')]]"
    )
...
def test_delete_comment(live_server, driver):
    ...
    assert driver.find_elements(
        By.XPATH, "//*[text()[contains(.,'#chickensofinstagram')]]"
    )
    ...
    cur_comment = driver.find_elements(
        By.XPATH, "//*[text()[contains(.,'#chickensofinstagram')]]"
    )
...
def test_like_unlike(live_server, driver):
    ...
    like_buttons = driver.find_elements(
        By.XPATH, "//button[contains(@class, 'like-unlike-button')]"
    )
    ...
    assert driver.find_elements(
        By.XPATH, "//*[contains(normalize-space(.), '0 likes')]"
    )
    ...
    assert driver.find_elements(
        By.XPATH, "//*[contains(normalize-space(.), '1 like')]"
    )
...
def test_refresh(live_server, driver):
    ...
    assert driver.find_elements(By.XPATH, "//a[@href='/posts/2/']")
    assert driver.find_elements(By.XPATH, "//a[@href='/posts/3/']")
    assert driver.find_elements(By.XPATH, "//a[@href='/posts/5/']")
...
def test_html(live_server, driver, tmpdir):
    ...
    html = (
        "<!DOCTYPE html>" + driver.page_source
    )  # Selenium strips DOCTYPE
